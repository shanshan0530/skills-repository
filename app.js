...
const files=[
['ai-prompts','grill-me.md'],['ai-prompts','prompt-optimizer.md'],['ai-prompts','awesome-web-prompts.md'],['ai-prompts','i-have-adhd.md'],['ai-prompts','llm-conflict-guide.md'],
['ai-tools','AIPlanHub.md'],['ai-tools','hillm.md'],['ai-tools','hermes-agent.md'],['ai-tools','openwork.md'],['ai-tools','agent-reach.md'],['ai-tools','skillopt.md'],['ai-tools','octop.md'],['ai-tools','x-mcp.md'],['ai-tools','awesome-agent-skills.md'],['ai-tools','browser-use.md'],['ai-tools','buzz.md'],['ai-tools','claude-plugins-official.md'],['ai-tools','herdr.md'],['ai-tools','maka.md'],['ai-tools','markitdown.md'],['ai-tools','grok-build.md'],['chrome-extensions','ciphermind.md'],
['creative-visual','holo-card-studio.md'],['creative-visual','hand-drawn-character-creator.md'],['creative-visual','photo-flipbook-ui.md'],['creative-visual','tait-crt-interface.md'],
['design-tools','impeccable.md'],['design-tools','metalforge.md'],['design-tools','better-design.md'],['design-tools','selene-design-taste.md'],['design-tools','kill-ai-slop.md'],['design-tools','web-to-design-md.md'],
['frontend-design','21st-dev.md'],['frontend-design','awesome-design-md.md'],['frontend-design','design-mobile-apps.md'],['frontend-design','design-taste-frontend.md'],['frontend-design','galaxy-frontend-design.md'],['frontend-design','gsap.md'],['frontend-design','image-to-code.md'],['frontend-design','motion-sites.md'],['frontend-design','motion-web.md'],['frontend-design','react-bits.md'],['frontend-design','refero-styles.md'],['frontend-design','threeui.md'],['frontend-design','web-design-guidelines.md'],['frontend-design','animal-island-ui.md'],['frontend-design','wechat-miniprogram-builder.md'],['frontend-design','ui-skills.md'],['frontend-design','liquid-glass-recipes.md'],
['methodology','lighthouse-travel-postcard-prompt.md'],['methodology','vibe-coding-approach.md'],['methodology','zeejay0-visual-skill-example.md'],['methodology','baiyueguang-learning-skill.md'],['methodology','ponytail.md'],['methodology','reverse-skill.md'],
...
['tools','bough.md'],['tools','no-negative-echo.md'],['tools','codex-dream-skin.md'],['tools','scrcpy.md'],['tools','ebook-treasure-chest.md'],['tools','svakom-ble-ai.md'],
['agent-memory','agentmemory.md'],['agent-memory','ai-memory.md'],['agent-memory','amos.md'],['agent-memory','awesome-ai-memory.md'],['agent-memory','claude-obsidian.md'],['agent-memory','codebase-memory-mcp.md'],['agent-memory','cognee.md'],['agent-memory','e-r-i-i.md'],['agent-memory','graphify.md'],['agent-memory','graphiti.md'],['agent-memory','hipocampus.md'],['agent-memory','memvid.md'],['agent-memory','nocturne-memory.md'],['agent-memory','nornicdb.md'],['agent-memory','opencode-kevin.md'],['agent-memory','openhuman.md'],['agent-memory','openviking.md'],['agent-memory','sochdb.md'],['agent-memory','soul-engine.md'],['agent-memory','tencentdb-agent-memory.md'],
['web-scraping','autoscraper.md'],['web-scraping','crawl4ai.md'],['web-scraping','crawlee.md'],['web-scraping','curl-impersonate.md'],['web-scraping','firecrawl.md'],['web-scraping','scrapling.md'],['web-scraping','scrapy.md'],
['voice-tts','chatterbox.md'],['voice-tts','fish-speech.md'],['voice-tts','livetranslate.md'],['voice-tts','voicebox.md'],['voice-tts','voxcpm.md'],
['virtual-companion','airi.md'],['virtual-companion','clawputer.md'],['virtual-companion','lumi-nox.md'],['virtual-companion','my-neuro.md'],['virtual-companion','nowhere.md'],['virtual-companion','open-llm-vtuber.md'],['virtual-companion','pixel-pets.md'],['virtual-companion','pngtuber-remix.md'],['virtual-companion','stackchan-mcp.md'],['virtual-companion','utsuwa.md'],
['games','estella.md'],['games','kaleidoscope-rp.md'],['games','llm-nursery.md'],['games','opengame.md'],['games','soonfx-core.md'],['games','usagi.md'],
['marketing-growth','ai-marketing-skills.md'],['marketing-growth','backlink-pilot.md'],['marketing-growth','marketingskills.md'],['marketing-growth','open-seo.md'],
['video-production','ai-image-generation.md'],['video-production','ai-music.md'],['video-production','ai-video-generation.md'],['video-production','anything2explainer.md'],['video-production','image-to-video.md'],['video-production','reddit-automation.md'],['video-production','seedance-image-to-video.md'],['video-production','seedance-reference-to-video.md'],['video-production','talkcraft.md'],['video-production','video-edit.md'],['video-production','video-shotcraft.md'],['video-production','wan-3-0-prime-reference-to-video.md'],['video-production','moneyprinterturbo.md'],['video-production','openmontage.md']
];

const categoryNames={
'all':'全部','frontend-design':'前端设计','photo-design':'照片设计','video-production':'视频制作','creative-visual':'创意视觉','design-tools':'设计工具','ai-prompts':'AI Prompt','token-optimization':'Token 优化','methodology':'方法论','ai-tools':'AI 工具','agent-memory':'Agent 记忆','web-scraping':'数据采集','voice-tts':'语音 TTS','virtual-companion':'虚拟陪伴','games':'游戏互动','marketing-growth':'营销增长','chrome-extensions':'浏览器扩展','tools':'通用工具'
};
